...
function spawn_enemies()
 ...
 malfin.special_dialog_2={"..ya ahora si", "mae es que estaba jugando", "smash con mi hermanillo", "y se puso a fumar espiral", "se encamoto y saco un chopo", "y me asuste", "en el agua deje un flotador", "talvez en la isla", "alguien pueda ayudar", "..si", "malparido ese", "...", "mae", "jueputa susto ah?", "...", "phew!"}
	...
	-- shooter
	shooter = make_actor(238,74,24)
	shooter.name="shooter"
	shooter.bigsprite=true
	shooter.can_move=false
	
	shooter_2 = make_actor(238,68,24)
	shooter_2.name="shooter"
	shooter_2.bigsprite=true
	shooter_2.can_move=false
	
	shooter_3 = make_actor(238,88,24)
	shooter_3.name="shooter"
	shooter_3.bigsprite=true
	shooter_3.can_move=false
