...
function spawn_enemies()
 ...
 malfin.special_dialog_2={"..ya ahora si", "mae es que estaba jugando", "smash con mi hermanillo", "y se puso a fumar espiral", "se encamoto y saco un chopo", "y me asuste", "en el agua deje un flotador", "talvez en la isla", "alguien pueda ayudar", "..si", "malparido ese", "...", "mae", "jueputa susto ah?", "...", "phew!"}
	...
	-- bouncy ball 2 sea 1
	shark = make_actor(33,70,26)
	shark.name="shark"
	shark.dx=0.15
	shark.dy=-0.5
	shark.friction=0.001
	shark.bounce=0.5
	
	-- bouncy ball 2 sea 2
	shark = make_actor(33,80,26)
	shark.name="shark"
	shark.dx=0.2
	shark.dy=-0.9
	...
	shooters[1] = {}
	shooters[1] = make_actor(238,74,24)
	...
	shooters[2] = {}
	shooters[2] = make_actor(238,68,24)
