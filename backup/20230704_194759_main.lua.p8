...
function move_actor(a)
 ...
 if eatable_a(a, a.dx, 0) and a.role=="protag" then
		debug.active=true
		debug.message="yummy"
		a.k=
		return nil
	end
	if eatable_a(a, a.dy, 0) and a.role=="protag" then
		debug.active=true
		debug.message="yummy"
		return nil
	end
...
function eatable_area(x,y,w,h)
 is_eatable = 
		eatable(x-w,y-h) or
		eatable(x+w,y-h) or
		eatable(x-w,y+h) or
		eatable(x+w,y+h)
		if pl.name=="lechu" and pl.bigsprite==true then
		 if is_eatable==true then
		  return true
		 end
		end
		return false
...
function eatable_a(a, dx, dy)
	if eatable_area(a.x,a.y,
				a.w,a.h) then
				return true end 
end
...
__gff__

...

